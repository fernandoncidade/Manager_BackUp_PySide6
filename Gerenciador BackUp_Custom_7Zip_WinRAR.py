...
from ManagerInterface_7Zip_WinRAR import GerenciadorInterface
from CompressionMethod_7Zip_WinRAR import MetodoCompressao
from Colors import (change_theme, apply_neutral_standart_theme, apply_light_theme,
                       apply_dark_theme, apply_blue_theme, apply_red_theme,
                       apply_green_theme, apply_purple_theme, apply_orange_theme,
                       apply_yellow_theme, apply_pink_theme)
